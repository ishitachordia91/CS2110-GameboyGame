...
OFILES = font.o myLib.o gamelogic.o mariobg.o mario.o luigi.o peach.o evilmushroom.o main.o 

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h mariobg.h mario.h luigi.h peach.h evilmushroom.h
